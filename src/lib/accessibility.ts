...
export function meetsWCAG(contrastRatio: number, level: 'AA' | 'AAA' = 'AA', size: 'normal' | 'large' = 'normal'): boolean {
  if (level === 'AAA') {
...
export const buttonColorValidation = {
  ...
  primary: hslToRgb(16, 45, 48),      // terracotta
  secondary: hslToRgb(220, 8, 46),    // neutral gray
  success: hslToRgb(155, 35, 48),     // sage green
  warning: hslToRgb(45, 90, 55),      // amber
  danger: hslToRgb(0, 75, 55),        // red
  
  // Text colors
  lightText: hslToRgb(35, 100, 97),   // very light
  darkText: hslToRgb(25, 8, 8),       // very dark
...
if (import.meta.env.DEV) {
  console.log('🎨 Button Color Contrast Validation:', buttonColorValidation.validate());
}